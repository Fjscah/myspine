"""
# classify loss fork from  : https://github.com/qubvel/segmentation_models.pytorch
 """
...
from train.dataset.dataloader import make_one_hot
...
class FocalLoss(_Loss):
    def __init__(
        ...
        Shape
             ...
             - **y_true** - torch.Tensor of shape  (N, C, H, W)  ?? or (N, H, W) 
    ...
    def forward(self, y_pred: torch.Tensor, y_true: torch.Tensor,ins=None) -> torch.Tensor:
...
if __name__=="__main__":
    ...
    a=torch.randint(0,2,(2,1,4,4))
    b=torch.randint(0,2,(2,1,4,4))
    a1=make_one_hot(a,2)
    b1=make_one_hot(b,2)
    loss1=focal_loss(a1,b1)
    # loss2=focal_loss(a1,b)
    # print(torch.abs(a-b).sum()/16/2,loss1,loss2)